...
if __name__ == '__main__':
    timeline_format = {'frameDuration': '100/2400s', 'height': '1080', 'id': 'r1', 'name': 'FFVideoFormat1080p24', 'width': '1920', 'tcStart': '3600s', 'tcFormat': 'NDF', 'duration': '9200/2400s', 'audioLayout': 'stereo', 'audioRate': '48k', 'fps': 24}
    ...
    o = Shot({'name': 'auf_sam_0000_edit-clientcut_v058_rsu', 'offset': '3601s', 'ref': 'r2', 'duration': '1s', 'start': '1s', 'audioRole': 'dialogue', 'tcFormat': 'NDF', 'shotCode': 'sam_0010a'})
    print(o.start)
    print('--------------------------------------------------------------')
